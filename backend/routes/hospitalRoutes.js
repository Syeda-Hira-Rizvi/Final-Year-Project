...
const {registerHospital, loginHospital, logoutHospital, forgotHospitalPassword, resetHospitalPassword, getHospitalInfo, updateHospitalInfo, changeHospitalPassword, getAllAppointments, getAllDonations, getHospitalDonors, getHospitalDonorById, getAllVolunteers, getVolunteerById, addSlots, getAllSlots, deleteSlots, confirmBloodDonationAppointment, confirmHLATestAppointment, getDonorsWithHLATestingDonations, uploadHLAresult, getDonorsWithUploadedHLAResults, confirmStemCellAppointment, createBloodDrive, getVolunteerApplications, acceptVolunteerApplication, rejectVolunteerApplication} = require('../controllers/hospitalController');
...
//router.route('/appointments/:hospitalId').get(isAuthenticatedUser, authorizeRoles('hospital'), getAllAppointments);
router.route('/appointments').get(isAuthenticatedUser, authorizeRoles('hospital'), getAllAppointments);

// router.route('/donations/:hospitalId').get(isAuthenticatedUser, authorizeRoles('hospital'), getAllDonations);
router.route('/donations').get(isAuthenticatedUser, authorizeRoles('hospital'), getAllDonations);

//router.route('/hospital-donors/:hospitalId').get(isAuthenticatedUser, authorizeRoles('hospital'), getHospitalDonors);
router.route('/hospital-donors').get(isAuthenticatedUser, authorizeRoles('hospital'), getHospitalDonors);

router.route('/hospital-donor/:hospitalId/:donorId').get(isAuthenticatedUser, authorizeRoles('hospital'), getHospitalDonorById);

// router.route('/hospital-volunteers/:hospitalId').get(isAuthenticatedUser, authorizeRoles('hospital'), getAllVolunteers);
router.route('/hospital-volunteers').get(isAuthenticatedUser, authorizeRoles('hospital'), getAllVolunteers);

router.route('/hospital-volunteer/:hospitalId/:volunteerId').get(isAuthenticatedUser, authorizeRoles('hospital'), getVolunteerById);

router.route('/add-slots').post(isAuthenticatedUser, authorizeRoles('hospital'), addSlots);

router.route('/get-all-slots').get(isAuthenticatedUser, authorizeRoles('hospital'), getAllSlots);

router.route('/delete-slots').delete(isAuthenticatedUser, authorizeRoles('hospital'), deleteSlots);

router.route('/confirm/blood-donation-appointment').post(isAuthenticatedUser, authorizeRoles('hospital'), confirmBloodDonationAppointment);

router.route('/confirm/HLA-test-appointment').post(isAuthenticatedUser, authorizeRoles('hospital'), confirmHLATestAppointment);
...
router.route('/confirm/stem-cell-appointment').post(isAuthenticatedUser, authorizeRoles('hospital'), confirmStemCellAppointment);
