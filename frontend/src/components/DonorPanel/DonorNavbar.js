...
// };
// const handleLogout = () => {
//   window.location.href = "/logout"; // Redirect to /logout route of frontend
// };
    ...
    <>
      <Navbar>
        ...
        <NavbarLinks>
          ...
          {/* <NavbarLink>
          <StyledLink to="/manageappointments">Manage Appointments</StyledLink>
        </NavbarLink> */}
          <NavbarLink>
            <StyledLink to="/blooddrive">Volunteering</StyledLink>
          </NavbarLink>

          {/* "Logout" button with same styling as "Book Now" */}
          {/* <NavbarLink>
      ...
      <Sidebar isOpen={sidebarOpen}>
        ...
        {/* <SidebarLink to="/stemcellappointment" onClick={handleSidebarItemClick}>Stemcell Appointment</SidebarLink> */}
        ...
        {/* <SidebarLink to="/logout" onClick={handleSidebarItemClick}>Log out</SidebarLink> */}
