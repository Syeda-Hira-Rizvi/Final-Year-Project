...
const ViewHLAStatus = () => {
  ...
  return (
    <Container>
      ...
      {!loading && !error && (
        <>
          {/* {showIneligibleMessage && (
            <IneligibleMessage>
              No HLA test result for donation. Please wait for further updates.If the result uploaded is "Matched", only then you can book Stem Cell Appointment.
            </IneligibleMessage>
          )} */}
          {showIneligibleMessage && (
            <IneligibleMessage>
      ...
      {/* Pass hospitalId as prop to StemcellAppointment */}
      {/* {hospitalId && <StemcellAppointment hospitalId={hospitalId} hospitalName={hospitalName}/>} */}
    </Container>
  );
};
