...
import { useNavigate } from 'react-router-dom'; // Import useNavigate for internal routing
...
function Footer() {
    ...
    const isLoggedIn = false; // Replace this with the actual logic to check login status

    const handleBookNowClick = () => {
        if (isLoggedIn) {
            navigate('/appointmentpage'); // Redirect to the appointment page if logged in
        } else {
            navigate('/login'); // Redirect to the login/auth page if not logged in
        }
    };
