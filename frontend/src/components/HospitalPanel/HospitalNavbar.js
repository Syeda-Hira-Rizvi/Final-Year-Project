  ...
  return (
    <>
      <Navbar>
        ...
        {/* <ButtonSmallScreen to="/logout">Log out</ButtonSmallScreen> */}
      ...
      <Sidebar isOpen={sidebarOpen}>
        ...
        {/* <Button to="/logoutHospital" onClick={handleSidebarItemClick}>Log out</Button> */}
        {/* <Button onClick={() => {handleSidebarItemClick(); handleLogout();}}>Log out</Button> */}
