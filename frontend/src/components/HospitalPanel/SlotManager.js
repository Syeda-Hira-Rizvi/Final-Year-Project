...
const SlotManager = () => {
  ...
  const handleSubmit = async () => {
    ...
    //       yearWide,
    //       date: yearWide ? undefined : date, // Send date only if yearWide is false
    //       year: yearWide ? year : undefined, // Send year only if yearWide is true
    //     });
      ...
      <Card>
        {/* <Label>
          <input
            type="checkbox"
            checked={yearWide}
            onChange={(e) => setYearWide(e.target.checked)}
          />
        ...
        {/* <Button onClick={handleSubmit} disabled={!yearWide && !date}>
          Add Slots
        </Button> */}
