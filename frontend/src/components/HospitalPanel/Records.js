...
// import HLARecords from "./HLARecords";
        ...
        return (
          <div style={{marginBottom: "60px"}}>
            ...
            <ul style={{ color: "#333", marginTop: "20px", lineHeight: "1.8", listStyleType: "none" }}>
              ...
              {/* <li>
                <FaClipboardList
                  style={{ color: "#b00000", marginRight: "8px" }}
                />
                <strong>HLA Records:</strong> Manage stem cell HLA test records
                and donor matches (if applicable).
              </li> */}
            </ul>
          </div>
        );
  ...
  return (
    <Container>
      ...
      <Sidebar isSidebarOpen={isSidebarOpen}>
        ...
        {/* {currentHospital.acceptsStemCellDonations && (
          <Button
            isSidebarOpen={isSidebarOpen}
            onClick={() => handleButtonClick("HLARecords")}
          >
